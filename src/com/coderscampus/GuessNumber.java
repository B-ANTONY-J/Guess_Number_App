...
//		Integers to describe range of min & max for nextInt class for inclusive to exclusive
		...
		//for practice purposes I printed the random cpu number so I could test my code more accurately - it can be removed any time without 
		//affecting the code
...
//				break;
			...
			} else if (randomInputCpu > convertInputUser) {
